...
public class ChatServidor extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        ChatServidor main = new ChatServidor();
        ExecutorService executor = Executors.newCachedThreadPool();
        main.setVisible(true);

        try {
            servidor = new ServerSocket(11111, 100);
            main.EstadoConexion("Esperando Clientes ...");
            ...
            while (true) {
                try {
                    ...
                    executor.execute(new HiloReceptor(conexion, main));
                    executor.execute(new HiloEnviador(conexion, main));
